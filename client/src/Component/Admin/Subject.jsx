...
export default function Subject() {
  ...
  useEffect(async () => {
    ...
    setLogin(isCheck);
    console.log("useeei efect subject", isCheck);
    if (isCheck) {
...
let text=`Deleting ${data.name}, Are you sure?`
  ...
  const setSubmitData = async (e) => {
    ...
    console.log("??>>}}??", isValid + " " + isNewDepartAdd);

    if (isValid === 0 && isNewDepartAdd) {
      // console.log("setV   we aeeee innn");
    ...
    <>
              ...
              <div>
                <div className="container row-cols-5 fl-row">
                  ...
                  >
                    <i className="bi bi-cloud-download-fill"></i> Download Subject Data List
                  </button>
                </div>
