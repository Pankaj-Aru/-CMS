  ...
  function onChangeHandlerA(e) {
    ...
    if (e.target.name === "dept" ) {
      if(notificationInfo.dept.includes(e.target.value)){
        const aa=notificationInfo.dept.filter((item)=>item!==e.target.value)
        setNotificationInfo({
          ...notificationInfo,
          dept: aa,
        });
      ...
      if(notificationInfo.semester.includes(e.target.value)){
        ...
        const aa=notificationInfo.semester.filter((item)=>item!==e.target.value)
...
let text=`Deleting ${title}, \n Are you sure? `
  ...
  async function addNotificationFun() {
    ...
    console.log(notificationInfo.file !== "");
    console.log(notificationInfo.semester !== "");
    console.log(notificationInfo.dept !== "");
    console.log(notificationInfo.facultyName !== "");
                  ...
                  <div className="col-sm-4  btn-search ">
                    ...
                    <table className="table table-striped">
                      ...
                      <tbody>
                       ...
                       if(searchItem===""){
                         return  val;
                       }else if(val.publisher.toLowerCase().includes(searchItem.toLowerCase())){
                          return val
                       }else if(val.semester.toString().includes(searchItem.toLowerCase())){
                         return val
                       }else if(val.dept.toString().toLowerCase().includes(searchItem.toLowerCase())){
                         return val
                       }
                          ...
                          return (
                            <>
                              <tr>
                                ...
                                <td>{item.title} </td>
                                <td>{item.semester.map((i)=>   <> {i.toUpperCase()}<br/> </>   ) } </td>
                                <td>{item.dept.map((i)=> i!=='it'?` - ${takeDepartment(i).split(" ")[0]} - `:"Information Techno."  ) }  </td>
